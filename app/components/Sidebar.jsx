...
export default function Sidebar() {
  return (
    <div className='hidden mt-3 sm:flex flex-col min-h-screen justify-between p-2 xl:items-start fixed'>
      {/* Twitter Logo */}
      ...
      {/* Mini-Profile */}
        <div className='hidden sm:flex space-x-3 items-center mb-5 p-3'>
